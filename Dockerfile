...
RUN cd / && wget https://root.cern.ch/download/root_v6.06.02.Linux-ubuntu14-x86_64-gcc4.8.tar.gz && tar -xvf root_v6.06.02.Linux-ubuntu14-x86_64-gcc4.8.tar.gz && . /root/bin/thisroot.sh
